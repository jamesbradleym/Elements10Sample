...
namespace Elements10Sample
{
    public class Function
    {
        ...
        private IModelStore<Elements10SampleInputs> store;

        public async Task<Elements10SampleOutputs> Handler(Elements10SampleInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<Elements10SampleInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<Elements10SampleInputs>();
                }
            }

            var l = new InvocationWrapper<Elements10SampleInputs,Elements10SampleOutputs> (store, Elements10Sample.Execute);
